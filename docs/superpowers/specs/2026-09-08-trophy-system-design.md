...
| Tracks | 9: total shots, 4× per-category volume (Lancer Franc / 3 Points / Mi-distance / Technique), session count, training-day streak, best-session accuracy, longest made-shot streak |
